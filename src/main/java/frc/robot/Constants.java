...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double driveKS = (0.08403 / 12);
        public static final double driveKV = (2.2341 / 12);
        public static final double driveKA = (0.27385 / 12);
        ...
        public static final class Mod0 {
            ...
            public static final double[] drivePIDF = {driveKP, driveKI, driveKD, driveKF};
        }
