...
import frc.robot.autos.AutoGetNote;
...
public class demopassCommandGroup extends SequentialCommandGroup {
    public demopassCommandGroup(SwerveDrive swervDrive, NotePlayerSubsystem notePlayer) {
        ...
        super(notePlayer.demothrow(), new demoturn(swervDrive), new AutoGetNote(swervDrive,notePlayer).andThen(notePlayer.intakeNote()));
    }
}